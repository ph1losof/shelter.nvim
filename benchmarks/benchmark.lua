...
local function run_benchmarks()
  ...
  for _, size in ipairs(SIZES) do
    ...
    print(string.format("  Parse:   shelter=%.3fms, cloak=%s",
      shelter_parse, cloak_parse and string.format("%.3fms", cloak_parse) or "N/A"))
    ...
    print(string.format("  Preview: shelter=%.3fms, cloak=%s",
      shelter_preview, cloak_preview and string.format("%.3fms", cloak_preview) or "N/A"))

    -- Edit benchmarks
    local shelter_edit = benchmark_shelter_edit(content, ITERATIONS)
    local cloak_edit = benchmark_cloak_edit(content, ITERATIONS)
    print(string.format("  Edit:    shelter=%.3fms, cloak=%s",
      shelter_edit, cloak_edit and string.format("%.3fms", cloak_edit) or "N/A"))
